;;; themes/night-solarized-light.el --- forked from Doom Solarized Light -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup night-solarized-light-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom night-solarized-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'night-solarized-light-theme
  :type 'boolean)

(defcustom night-solarized-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'night-solarized-light-theme
  :type 'boolean)

(defcustom night-solarized-light-comment-bg night-solarized-light-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'night-solarized-light-theme
  :type 'boolean)

(defcustom night-solarized-light-padded-modeline doom-themes-padded-modeline
...
;;
(def-doom-theme night-solarized-light
  ...
  ((bg         '("#FDF6E3" "#FDF6E3" nil            ))
   ...
   ;; (selection      green)
   (builtin        magenta)
   (comments       (if night-solarized-light-brighter-comments
   ...
   (-modeline-bright night-solarized-light-brighter-modeline)
   (-modeline-pad
    (when night-solarized-light-padded-modeline
      (if (integerp night-solarized-light-padded-modeline) night-solarized-light-padded-modeline 4)))
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   (font-lock-comment-face
    :slant 'italic
    :foreground comments
    :background (if night-solarized-light-comment-bg (doom-blend teal base0 0.07)))
...
;;; night-solarized-light-theme.el ends here
