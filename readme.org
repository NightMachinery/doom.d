...
*** Still ungated, and worth knowing: =copilot-mode= sends the *whole buffer* continuously and automatically, the upstream =ellama-command-map= has ~17 more =ellama-stream= call sites, and gptel sends the Org ancestry of point.
