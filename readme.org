...
*** =emc-tealy= and =emc-tealy-tmux= send oversized copies through SSH, with 15-minute successful readiness caching and 30-second failure caching. Clear it with =emc-tealy-cache-clear= or =M-x night/mobile-clipboard-cache-clear=.
** Yasnippet
