...
How much text "around point" means, and whether the buffer may be sent at all,
are decided by the scope and the path policy that FIM shares with the ellama
