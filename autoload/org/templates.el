...
(add-to-list 'org-structure-template-alist '("sj" . "src jupyter-julia :session j1"))
(add-to-list 'org-structure-template-alist '("sb" . "src bash :results verbatim :exports both"))
