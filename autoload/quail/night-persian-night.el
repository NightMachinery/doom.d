;;; night-persian-night.el --- Quail package for inputting Persian/Farsi keyboard	-*- coding: utf-8; lexical-binding: t -*-
;; @forked from [[id:0739da1f-f4d8-4f3a-b272-b99ecb6f6541][bx-blee/persian-input-method: Emacs input-methods that support Persian/Farsi editing.]]
;; This is actually not the latest version, and I haven't really changed anything in it. You should copy the latest version if you want to change anything.
;;;
...
(quail-define-package
 "farsi-isiri-9147-night" "Persian" " ف" nil
...
(quail-define-package
 "farsi-transliterate-banan-night" "Persian" "ب" t
...
;;; night-persian-night.el ends here
